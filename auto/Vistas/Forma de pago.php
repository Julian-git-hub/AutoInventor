...
if(isset($_POST["consulta"]))
{
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from forma_de_pago where Descripcion like '%$obj->Descripcion%'";
...
<body>
    ...
    <form action="" method="POST">
        <div class="consultas">
            ...
            <a href="agregarformadepago.php"><button type="button">Agregar Forma de pago</button></a>
            <br>
        </div>
        <br>    
            <div class="formM">
                    ...
                    <tr>
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0] <> ""){
                                echo "modificarFormadepago.php?key=".urlencode($arreglo[0]);
                            }else{
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0]<>""){
                                        echo "eliminarFormadepago.php?key=".urlencode($arreglo[0]);
                            }else{
                                echo "<script> alert('debe de consultar primero')</sccript>";
                            }
                                ?>">
