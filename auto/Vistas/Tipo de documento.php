...
if(isset($_POST["consulta"]))
{
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from tipo_de_documento where Descripcion like '%$obj->Descripcion%'";
...
<body>
    <h1 style="text-align: center;">Tipo de Documento</h1>
    <form action="" method="POST">
        <div class="consultas">
            ...
            <a href="agregarTipodocumento.php"><button type="button">Agregar Tipo de Documento</button></a>
            <br>
        </div>
        <br>
            <div class="formM">
                    ...
                    <tr>
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0] <> ""){
                                echo "modificarTipoDocumento.php?key=".urlencode($arreglo[0]);
                            }else{
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0]<>""){
                                        echo "eliminarTipoDocumento.php?key=".urlencode($arreglo[0]);
                            }else{
                                echo "<script> alert('debe de consultar primero')</sccript>";
                            }
                                ?>">
