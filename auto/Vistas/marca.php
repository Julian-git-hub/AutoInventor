...
if(isset($_POST["consulta"]))
{
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from marca where Modelo like '%$obj->Modelo%'";
...
<body>
    <h1 style="text-align: center;">Agregar Marca</h1>
    <form action="" method="POST">
        <div class="consultas">
            ...
            <a href="../Reportes/Reportemarcas.php"><button type="button">Generar Excel</button></a>
        </div>
        <br>
            <div class="formM">
                <table class="tabla">    
