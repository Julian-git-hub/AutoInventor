...
<?php
    ...
    if($arreglo = mysqli_fetch_row($resultado)){;
        ...
        $obj->ID_movcabecera = null;
        $obj->Fecha = null;
        $obj->Num_documento = null;
        $obj->ID_terceros = null;
        $obj->ID_formapago = null;
        $obj->ID_tipodocumento = null;
    }?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <form action="" method="POST" style="height: 100px">
        ...
        <div class="formM">
            <div class="tabla1">
                ...
                <input type="text" style="width: 99%; height: 30px; border-radius: 5px;" id="Num_documento" name="Num_documento" value="<?php echo $obj->Num_documento?>" placeholder="Digite el numero de documento">
                <br>
                ...
                <br>
                <label for="" method="POST">ID formapago</label>
