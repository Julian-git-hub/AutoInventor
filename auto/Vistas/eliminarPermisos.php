<?php
    ...
    include("../modelo/permisosmodelo.php");
?>
<?php
$obj = new permisos();
if($_POST){
...
<?php
    ...
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from permisos where ID_permisos = '$llave'";
    $resultado = mysqli_query($cone,$sql);
    if($arreglo = mysqli_fetch_row($resultado)){;
        $obj->ID_permisos = $arreglo[0];
        $obj->Descripcion = $arreglo[1];
    }else{
        $obj->ID_permisos = null;
    ...
    <form action="" method="POST" style="height: 100px">
        ...
        <div class="formM">
            <div class="tabla1">
                ...
                <input type="text" style="width: 99%; height: 30px; border-radius: 5px;" id="ID_permisos" name="ID_permisos" value="<?php echo $obj->ID_permisos?>" placeholder="automatico">
                <br>
            ...
            <a href="permisos.php"><button type="button" name="salir">Salir</button></a>
        </div>
        </div>
</body>
</html>