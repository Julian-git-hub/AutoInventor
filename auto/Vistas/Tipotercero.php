...
if(isset($_POST["consulta"]))
{
    $c = new Conexion();
    $cone = $c->conectando();
    $sql = "select * from tipo_terceros where Descripcion like '%$obj->Descripcion%'";
...
<body>
    <h1 style="text-align: center;">Tipo Tercero</h1>
    <form action="" method="POST">
        <div class="consultas">
            ...
            <a href="agregarTipoTercero.php"><button type="button">Agregar Tipo Tercero</button></a>
            <br>
        </div>
        <br>
            <div class="formM">
                    ...
                    <tr>
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0] <> ""){
                                echo "modificarTipoTercero.php?key=".urlencode($arreglo[0]);
                            }else{
                        ...
                        <td class="letra">
                            <a href="<?php if($arreglo[0]<>""){
                                        echo "eliminarTipoTercero.php?key=".urlencode($arreglo[0]);
                            }else{
                                echo "<script> alert('debe de consultar primero')</sccript>";
                            }
                                ?>">
